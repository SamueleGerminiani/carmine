...
class Checker3_r2 : public Checker {
   public:
    Checker3_r2(size_t nVars, size_t priority, std::string handlerName,
              std::string checkerName);

    ~Checker3_r2() override;
    bool eval() override;
   ...
   bool eval_Checker3_r2(bool p0,bool p1,bool reset = false);
