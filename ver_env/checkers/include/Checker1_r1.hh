...
class Checker1_r1 : public Checker {
   public:
    Checker1_r1(size_t nVars, size_t priority, std::string handlerName,
              std::string checkerName);

    ~Checker1_r1() override;
    bool eval() override;
   ...
   bool eval_Checker1_r1(bool p0,bool p1,bool reset = false);
