...
class Checker2_r1 : public Checker {
   public:
    Checker2_r1(size_t nVars, size_t priority, std::string handlerName,
              std::string checkerName);

    ~Checker2_r1() override;
    bool eval() override;
    void notifyFailure() override;
    void clearData() override;
   void addEvent_vel0(ros::Time ts, double value);


   private:

   bool eval_Checker2_r1(bool p0,bool p1,bool reset = false);
    ...
    union Value {
      Value(const double var, size_t id): _vel0(var){}
      double _vel0;
