...
class Checker2_r2 : public Checker {
   public:
    Checker2_r2(size_t nVars, size_t priority, std::string handlerName,
              std::string checkerName);

    ~Checker2_r2() override;
    bool eval() override;
   ...
   bool eval_Checker2_r2(bool p0,bool p1,bool reset = false);
