#include "visitors/VarsExtractVisitor.hh"
...
#define EXPRESSION(NODE)                                                       \
  void VarsExtractVisitor::visit(expression::NODE &o) {                              \
...
VarsExtractVisitor::VarsExtractVisitor() : ExpVisitor() {
  // proposition
...
void VarsExtractVisitor::visit(expression::PropositionNot &o) {
  o.getItems()[0]->acceptVisitor(*this);
}

void VarsExtractVisitor::visit(expression::LogicNot &o) {
  o.getItems()[0]->acceptVisitor(*this);
}
void VarsExtractVisitor::visit(__attribute__((unused))
                               expression::NamedLogicConstant &o) {}
