...
public:
  ...
  virtual void enterNamedLogicConst(propositionParser::NamedLogicConstContext * /*ctx*/) override { }
  virtual void exitNamedLogicConst(propositionParser::NamedLogicConstContext * /*ctx*/) override { }
  ...
  virtual void enterEnumVariable(propositionParser::EnumVariableContext * /*ctx*/) override { }
  virtual void exitEnumVariable(propositionParser::EnumVariableContext * /*ctx*/) override { }

  virtual void enterEnumName(propositionParser::EnumNameContext * /*ctx*/) override { }
  virtual void exitEnumName(propositionParser::EnumNameContext * /*ctx*/) override { }

  virtual void enterNamedConst(propositionParser::NamedConstContext * /*ctx*/) override { }
  virtual void exitNamedConst(propositionParser::NamedConstContext * /*ctx*/) override { }
