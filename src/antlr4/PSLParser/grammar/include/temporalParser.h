...
public:
  ...
  enum {
    RuleFormula = 0, RuleSere = 1, RuleTformula = 2, RuleBoolean = 3, RuleBooleanAtom = 4, 
    RuleBooleanConstant = 5, RuleBooleanVariable = 6, RuleLogic = 7, RuleLogicAtom = 8, 
    RuleLogicConstant = 9, RuleNamedLogicConst = 10, RuleLogicVariable = 11, 
    RuleEnumVariable = 12, RuleEnumName = 13, RuleNamedConst = 14, RuleNumeric = 15, 
    RuleNumericAtom = 16, RuleNumericConstant = 17, RuleNumericVariable = 18, 
